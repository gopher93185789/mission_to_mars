...
export function Music() {
    ...
    return (
        ...
        <div className="h-full w-full mt-5 p-5 flex items-center flex-col ">
            <div className="w-4/5 h-full rounded-xl flex gap-5">
                <div id="side1" className="h-full w-2/12 backdrop-blur-xl border rounded-xl ">
                    
                </div>

                <div id="middle" className="w-full h-[1050px] justify-center rounded-xl scrollbar scrollbar-none overflow-y-auto gap-5 flex-col">
                    <div className="h-[540px]  w-full rounded-3xl flex group  bg-orange-700">
                        <div className="w-1/2 h-full px-20 pt-32 pb-16 flex flex-col gap-5">
                            <p className="px-1 w-full text-left text-2xl text-white">curated playlist</p >
                            <h1 className="font-bold w-full text-left text-8xl text-white">R&B Hits</h1>
                            <p className="text-opacity-50 px-1 w-full text-left text-2xl text-white">the Weeknd, Usher, Kendrick Lamar, Diddy, Byson Tiller, Tory Lanez</p >
                    ...
                    <p className="text-white text-2xl font-bold px-1 mt-3">Made for you</p>
                    ...
                    <p className="text-white text-2xl font-bold px-1 mt-3">Explore</p>
                    ...
                    <p className="text-white text-2xl font-bold px-1 mt-3">Moody</p>
                    ...
                    <p className="text-white text-2xl font-bold px-1 mt-3">Sigma</p>
                ...
                <div id="side2" className="h-full w-2/12 backdrop-blur-xl border  rounded-xl"></div>
            </div>
